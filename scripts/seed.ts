...
//the user id i get from clerk 
//i picked a specefic user and copied his user id 
const SEED_USER_ID = "user_2okGvVZpLWa7fsRdpqKXWmHtD5I";
...
// Array for holding generated transactions.
const SEED_TRANSACTIONS: (typeof transactions.$inferSelect)[] = [];

import { eachDayOfInterval, format } from "date-fns";
import { convertAmountToMiliunits } from "@/lib/utils";

// Generates random transaction amounts based on category type.
...
// Generates a set of transactions for a specific day.
...
// Generates transactions for a specified interval.
